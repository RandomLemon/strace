...
MPERS_PRINTER_DECL(bool, fetch_struct_statfs, struct tcb *const tcp, const kernel_ulong_t addr, struct strace_statfs *const p)
{
 struct_statfs b;
...
MPERS_PRINTER_DECL(bool, fetch_struct_statfs64, struct tcb *const tcp, const kernel_ulong_t addr, const kernel_ulong_t size, struct strace_statfs *const p)
{
 struct_statfs64 b;
        if (sizeof(b) != size
    ) {
