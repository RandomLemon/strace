...
extern int adjtimex (struct timex *__ntx) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1)));
extern int ntp_gettimex (struct ntptimeval *__ntv) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1)));
extern int ntp_gettime (struct ntptimeval *__ntv) __asm__ ("" "ntp_gettimex") __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1)));
extern int ntp_adjtime (struct timex *__tntx) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1)));
