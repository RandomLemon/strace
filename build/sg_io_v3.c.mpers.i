...
decode_request(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 print_sg_io_buffer(tcp, ((kernel_ulong_t) (unsigned long) (sg_io.cmdp)), sg_io.cmd_len, 0);
 ...
 if (sg_io.dxfer_direction == -2 ||
  ...
  tprints(", dxferp=");
  print_sg_io_buffer(tcp, ((kernel_ulong_t) (unsigned long) (sg_io.dxferp)),
...
decode_response(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 if (umoven((tcp), (arg), sizeof(*(&sg_io)), (void *) (&sg_io)) < 0) {
  if (entering_sg_io->dxfer_direction == -3) {
   tprints(", dxferp=");
   printaddr(((kernel_ulong_t) (unsigned long) (entering_sg_io->dxferp)));
  }
  tprints(", sbp=");
  printaddr(((kernel_ulong_t) (unsigned long) (entering_sg_io->sbp)));
  return 0100 | 1;
 }
 ...
 if (sg_io.dxfer_direction == -3 ||
  ...
  if (sg_io.dxfer_direction == -3 || din_len) {
   print_sg_io_buffer(tcp, ((kernel_ulong_t) (unsigned long) (sg_io.dxferp)),
 ...
 print_sg_io_buffer(tcp, ((kernel_ulong_t) (unsigned long) (sg_io.sbp)), sg_io.sb_len_wr, 0);
