     ...
     const kernel_ulong_t arg, const struct_ifreq *const ifr)
{
 ...
 case 0x8916:
 case 0x8915:
  do { tprints("ifr_addr" "="); print_sockaddr(tcp, &((ifr)->ifr_ifru.ifru_addr), sizeof((ifr)->ifr_ifru.ifru_addr)); } while (0);
  break;
 case 0x8918:
 case 0x8917:
  do { tprints("ifr_dstaddr" "="); print_sockaddr(tcp, &((ifr)->ifr_ifru.ifru_dstaddr), sizeof((ifr)->ifr_ifru.ifru_dstaddr)); } while (0);
  break;
 case 0x891a:
 case 0x8919:
  do { tprints("ifr_broadaddr" "="); print_sockaddr(tcp, &((ifr)->ifr_ifru.ifru_broadaddr), sizeof((ifr)->ifr_ifru.ifru_broadaddr)); } while (0);
  break;
 case 0x891c:
 case 0x891b:
  do { tprints("ifr_netmask" "="); print_sockaddr(tcp, &((ifr)->ifr_ifru.ifru_netmask), sizeof((ifr)->ifr_ifru.ifru_netmask)); } while (0);
  break;
 case 0x8924:
 case 0x8927: {
